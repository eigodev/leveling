...
const headlineContent = [
    'Now, listen to Angela and John Talking.',
    'Now, listen to Nora and Ben talking'
];
const questionContent = [
    [
        'Angela and John are _.',
        "Angela doesn't _."
    ],
    [
        "Ben didn't go to _.",
        'Ben enjoyed the trip because he _.'
    ]
];
const questionDropdownOptions = [
    [
        ['in a gym', 'in a park', "at John's house"],
        ['exercise', 'lift weights', 'go jogging']
    ],
    [
        ['Acapulco', 'Oaxaca', 'Puerto Escondido'],
        ['got a lot of sun', 'met a lot of tourists', 'went surfing']
    ]
];
const AUDIO_SOURCE = 'Audios/IC5_L1_T1-8A_Track09.mp3';
const audioSegments = [
    { start: 38, end: 70 },
    { start: 101, end: 138 }
];
