...
const expectedAnswers = {
    ...
    exercise10: {
        // Level 2 – Exercise 10 (error correction)
        sentences: ['were', 'out', 'use', 'when', 'opening']
    }
};
...
function exportStudentReportPdf () {
    ...
    if (exerciseOneHistory && Array.isArray(exerciseOneHistory.details)) {
        ...
        // Level 2 – Exercise 1a mapping
        const exerciseOneAConfig = [
            {
            questionIndex: 0,
            itemLabel: '1',
            review: '3',
            area: 'Listening: Expressing wishes',
            },
            {
            questionIndex: 1,
            itemLabel: '2',
            review: '5',
            area: 'Listening: Advice',
            },
        ];
        
        // Level 2 – Exercise 1b mapping
        const exerciseOneBConfig = [
            {
                questionIndex: 2,
                itemLabel: '1',
                review: '2',
                area: 'Listening: Asking for information',
            },
            {
                questionIndex: 3,
                itemLabel: '2',
                review: '4',
                area: 'Listening: Giving instructions',
            },
        ];
    ...
    const exerciseSpecificConfigs = {
        ...
        Two: [
            {
                ...
                itemLabel: '1',
                review: '6/8',
                area: 'Grammar: Requests with modals and Would you mind... ?'
            },
            {
                detailIndex: 1,
                itemLabel: '4',
            ...
            },
            {
                ...
                itemLabel: '2',
                review: '5/7',
                area: 'Grammar: Modals for necessity and suggestion'
            },
            {
                detailIndex: 3,
                itemLabel: '3',
        ...
        Three: [
            {
                ...
                itemLabel: '1',
                review: '5/3',
                area: 'Grammar: Future with be going to and will'
            },
            {
                detailIndex: 1,
                itemLabel: '6',
            ...
            },
            {
                ...
                itemLabel: '2',
                review: '1/3',
                area: 'Grammar: Past tense'
            },
            {
                detailIndex: 3,
                itemLabel: '3',
                review: '4/4',
                area: 'Grammar: Simple past vs. present perfect'
            },
            {
                detailIndex: 4,
                itemLabel: '4',
            ...
            },
            {
                ...
                itemLabel: '5',
                review: '2/9',
                area: 'Grammar: Indirect questions from Wh-questions'
            }
        ]
        ,
        // Exercise 4 – 5 items
        ...
        Five: [
            {
                ...
                itemLabel: '1',
                review: '2/3',
                area: 'Grammar: Expressions of quantity'
            },
            {
                detailIndex: 1,
                itemLabel: '4',
            ...
            },
            {
                ...
                itemLabel: '2',
                review: '3/3',
                area: 'Grammar: Evaluations and comparisons'
            },
            {
                detailIndex: 4,
                itemLabel: '3',
        ...
        Six: [
            {
                ...
                itemLabel: '1',
                review: '2/1',
                area: 'Vocabulary: Compound nouns'
            },
            {
                detailIndex: 1,
                itemLabel: '2',
                review: '6/5',
                area: 'Vocabulary: Housework'
            },
            {
                detailIndex: 2,
                itemLabel: '6',
            ...
            },
            {
                ...
                itemLabel: '3',
                review: '3/1',
                area: 'Vocabulary: Homes'
            },
            {
                detailIndex: 4,
                itemLabel: '4',
                review: '5/4',
                area: 'Vocabulary: Travel preparations'
            },
            {
                detailIndex: 5,
                itemLabel: '5',
                review: '7/5',
                area: 'Vocabulary: Plugged in'
            }
        ],
        // Exercise 7 – 8 items
        Seven: [
        ...
        Eight: [
            {
                ...
                itemLabel: '1',
                review: '8',
                area: 'Reading: Topic on a festival; true/false comprehension check'
            },
            {
                detailIndex: 1,
                itemLabel: '2',
        ...
        Nine: [
            {
                ...
                itemLabel: '1',
                review: '7/8',
                area: 'Grammar: Imperatives and infinitives for giving suggestions'
            },
            {
                detailIndex: 1,
                itemLabel: '2',
            ...
            },
            {
                ...
                itemLabel: '4',
                review: '7/3',
                area: 'Grammar: Infinitives and gerunds for uses and purposes'
            },
            {
                detailIndex: 4,
                itemLabel: '5',
                review: '8/10',
                area: 'Grammar: Adverbial clauses of time'
            }
        ],
        ...
        Ten: [
            ...
            },
            {
                ...
                itemLabel: '2',
                review: '6/3',
                area: 'Grammar: Two-part verbs'
            },
            {
                detailIndex: 2,
                itemLabel: '3',
                review: '1/8',
                area: 'Grammar: Used to'
            },
            {
                detailIndex: 3,
                itemLabel: '4',
                review: '8/4',
                area: 'Grammar: Relative clauses of time'
            },
            {
                detailIndex: 4,
                itemLabel: '5',
