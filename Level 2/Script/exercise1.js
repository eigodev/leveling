...
const headlineContent = [
    'Now, listen to Paulo and Georgia talking.',
    'Now, listen to Dave and Michelle talking'
];
const questionContent = [
    [
        'Georgia wishes she _.',
        "Paulo thinks she should _."
    ],
    [
        "Michelle wants _.",
        'Michelle tells Dave to first _.'
    ]
];
const questionDropdownOptions = [
    [
        ['could do a better job', 'had another teacher', 'could be a better writer'],
        ['write about it', 'change schools', 'talk to her teacher']
    ],
    [
        ['to plan a pool party', "to know who's bringing the food", 'to eat some chicken salad'],
        ['cut up the chicken', 'cut up the onions and celery', 'bake, barbecue, or broil the chicken']
    ]
];
const AUDIO_SOURCE = 'Audios/IC5_L2_T1-8A_Track09.mp3';
const audioSegments = [
    { start: 40, end: 78 },
    { start: 110, end: 152 }
];
