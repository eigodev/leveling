...
const headlineContent = [
    'Now, listen to Kate and Rob talking.',
    'Now, listen to Charlie and Sonia talking'
];
const questionContent = [
    [
        'In the morning, Rob was _.',
        "Next week, Kate is going to _."
    ],
    [
        "Grace is a person who _.",
        'Sonia prefers it when people _.'
    ]
];
const questionDropdownOptions = [
    [
        ['cleaning his apartment', 'feeding his fish', 'packing his suitcase'],
        ["take care of Rob’s apartment", "be out of town on vacation", "go on a trip with Rob"]
    ],
    [
        ['likes to have fun', 'talks about politics', 'is too serious'],
        ["don't talk about their problems", 'can talk about different things', 'keep changing the subject']
    ]
];
const AUDIO_SOURCE = 'Audios/IC5_L3_T1-8A_Track09.mp3';
const audioSegments = [
    { start: 40, end: 93 },
    { start: 125, end: 173 }
];
...
function buildQuestionTextFragment (questionText, dropdownOptions = []) {
    ...
    parts.forEach((part, partIndex) => {
        ...
        if (partIndex !== parts.length - 1) {
            fragment.appendChild(createQuestionDropdown(dropdownOptions));
        }
    });
