...
const headline = [
    ...
    "Math the parts to make logical sentences",
    "Read about the nuclear disaster in Fukushima",
    "Fill in the blank with the correct form of the verb",
    "Complete the paragraph with the correct form of the verbs.",
...
const guideline = [
    ...
    "Write the correct word or words on the blank",
